...
namespace ProductWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            //สร้างข้อมูลบทบาทถ้ายังไม่มี สามารถป้อนด้วยมือโดยตรงที่ฐานข้อมูลก็ได้
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded) //ถ้าลงทะเบียนสำเร็จ
                {
                    _logger.LogInformation("User created a new account with password.");


                    #region MyRoll กำหนดเพิ่มบทบาทให้กับผู้ใช้
                    if (Input.Role == null)
                    {
        ...
        //แก้ไขจาก IdentityUser เป็น User
